...
Save them in the correct format (this can be loaded dirctly into **ProSpect** with *speclib_FITSload*).

```{r}
Rfits_write(PG_Ch_Mi_C3K, file.path(path_to_SSP,'SSP_paper/PG_Ch_Mi_C3K.fits'), flatten = T)
Rfits_write(PG_Ch_Mi_PHOENIX, file.path(path_to_SSP,'PG_Ch_Mi_PHOENIX.fits'), flatten = T)
Rfits_write(PG_Ch_Mi_MILES, file.path(path_to_SSP,'SSP_paper/PG_Ch_Mi_MILES.fits'), flatten = T)
Rfits_write(PG_Ch_Mi_BASEL, file.path(path_to_SSP,'SSP_paper/PG_Ch_Mi_BASEL.fits'), flatten = T)
```
