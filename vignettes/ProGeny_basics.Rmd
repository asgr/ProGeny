...
Here we load four different base spectra options: C3K, PHOENIX (Husser) MILES and BaSeL (msotly styled as BASEL below). To get these locally you will need to run *progenyAtmosDownload*. The below might take about a minute to run (depending on the speed of your HDD or SSD).
